...
RazorGuard AI is an independent student project created for the Razorpay AI Buildathon and educational/research purposes.

It is not an internal Razorpay system and does not use Razorpay confidential or production data.
